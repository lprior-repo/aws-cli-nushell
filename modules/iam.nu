...
# Service metadata
export def "aws iam info" []: nothing -> record {
    {
        service: "iam",
        operations_count: 164,
...
export def "aws iam addclientidtoopenidconnectprovider" []: nothing -> any {
    # Check if in mock mode
    let mock_env_var = "IAM_MOCK_MODE"
    ...
    if $mock_mode {
        # Return mock response
        {
            ...
            message: "Mock response for iam addclientidtoopenidconnectprovider"
        }
    } else {
        # Execute AWS CLI with error handling
        try {
            aws iam addclientidtoopenidconnectprovider | from json
        } catch { |err|
            error make {
...
export def "aws iam addroletoinstanceprofile" []: nothing -> any {
    # Check if in mock mode
    let mock_env_var = "IAM_MOCK_MODE"
    let mock_mode = try { $env | get $mock_env_var | into bool } catch { false }
    ...
    if $mock_mode {
        # Return mock response
        {
            ...
            message: "Mock response for iam addroletoinstanceprofile"
        }
    } else {
        # Execute AWS CLI with error handling
        try {
            aws iam addroletoinstanceprofile | from json
        } catch { |err|
            error make {
                msg: $"AWS CLI error: { $err.msg }",
                label: {
...
export def "aws iam addusertogroup" []: nothing -> any {
    # Check if in mock mode
    let mock_env_var = "IAM_MOCK_MODE"
    let mock_mode = try { $env | get $mock_env_var | into bool } catch { false }
    ...
    if $mock_mode {
        # Return mock response
        {
            ...
            message: "Mock response for iam addusertogroup"
        }
    } else {
        # Execute AWS CLI with error handling
        try {
            aws iam addusertogroup | from json
        } catch { |err|
            error make {
                msg: $"AWS CLI error: { $err.msg }",
                label: {
...
export def "aws iam attachgrouppolicy" []: nothing -> any {
    # Check if in mock mode
    let mock_env_var = "IAM_MOCK_MODE"
    let mock_mode = try { $env | get $mock_env_var | into bool } catch { false }
    ...
    if $mock_mode {
        # Return mock response
        {
            ...
            message: "Mock response for iam attachgrouppolicy"
        }
    } else {
        # Execute AWS CLI with error handling
        try {
            aws iam attachgrouppolicy | from json
        } catch { |err|
            error make {
                msg: $"AWS CLI error: { $err.msg }",
                label: {
...
export def "aws iam attachrolepolicy" []: nothing -> any {
    # Check if in mock mode
    let mock_env_var = "IAM_MOCK_MODE"
    let mock_mode = try { $env | get $mock_env_var | into bool } catch { false }
    ...
    if $mock_mode {
        # Return mock response
        {
            ...
            message: "Mock response for iam attachrolepolicy"
        }
    } else {
        # Execute AWS CLI with error handling
        try {
            aws iam attachrolepolicy | from json
        } catch { |err|
            error make {
                msg: $"AWS CLI error: { $err.msg }",
                label: {
...
export def "aws iam attachuserpolicy" []: nothing -> any {
    # Check if in mock mode
    let mock_env_var = "IAM_MOCK_MODE"
    let mock_mode = try { $env | get $mock_env_var | into bool } catch { false }
    ...
    if $mock_mode {
        # Return mock response
        {
            ...
            message: "Mock response for iam attachuserpolicy"
        }
    } else {
        # Execute AWS CLI with error handling
        try {
            aws iam attachuserpolicy | from json
        } catch { |err|
            error make {
                msg: $"AWS CLI error: { $err.msg }",
                label: {
...
export def "aws iam changepassword" []: nothing -> any {
    # Check if in mock mode
    let mock_env_var = "IAM_MOCK_MODE"
    let mock_mode = try { $env | get $mock_env_var | into bool } catch { false }
    ...
    if $mock_mode {
        # Return mock response
        {
            ...
            message: "Mock response for iam changepassword"
        }
    } else {
        # Execute AWS CLI with error handling
        try {
            aws iam changepassword | from json
        } catch { |err|
            error make {
                msg: $"AWS CLI error: { $err.msg }",
                label: {
...
export def "aws iam createaccesskey" []: nothing -> any {
    # Check if in mock mode
    let mock_env_var = "IAM_MOCK_MODE"
    let mock_mode = try { $env | get $mock_env_var | into bool } catch { false }
    ...
    if $mock_mode {
        # Return mock response
        {
            ...
            message: "Mock response for iam createaccesskey"
        }
    } else {
        # Execute AWS CLI with error handling
        try {
            aws iam createaccesskey | from json
        } catch { |err|
            error make {
                msg: $"AWS CLI error: { $err.msg }",
                label: {
...
export def "aws iam createaccountalias" []: nothing -> any {
    # Check if in mock mode
    let mock_env_var = "IAM_MOCK_MODE"
    let mock_mode = try { $env | get $mock_env_var | into bool } catch { false }
    ...
    if $mock_mode {
        # Return mock response
        {
            ...
            message: "Mock response for iam createaccountalias"
        }
    } else {
        # Execute AWS CLI with error handling
        try {
            aws iam createaccountalias | from json
        } catch { |err|
            error make {
                msg: $"AWS CLI error: { $err.msg }",
                label: {
...
export def "aws iam creategroup" []: nothing -> any {
    # Check if in mock mode
    let mock_env_var = "IAM_MOCK_MODE"
    let mock_mode = try { $env | get $mock_env_var | into bool } catch { false }
    ...
    if $mock_mode {
        # Return mock response
        {
            ...
            message: "Mock response for iam creategroup"
        }
    } else {
        # Execute AWS CLI with error handling
        try {
            aws iam creategroup | from json
        } catch { |err|
            error make {
                msg: $"AWS CLI error: { $err.msg }",
                label: {
...
export def "aws iam createinstanceprofile" []: nothing -> any {
    # Check if in mock mode
    let mock_env_var = "IAM_MOCK_MODE"
    let mock_mode = try { $env | get $mock_env_var | into bool } catch { false }
    ...
    if $mock_mode {
        # Return mock response
        {
            ...
            message: "Mock response for iam createinstanceprofile"
        }
    } else {
        # Execute AWS CLI with error handling
        try {
            aws iam createinstanceprofile | from json
        } catch { |err|
            error make {
                msg: $"AWS CLI error: { $err.msg }",
                label: {
...
export def "aws iam createloginprofile" []: nothing -> any {
    # Check if in mock mode
    let mock_env_var = "IAM_MOCK_MODE"
    let mock_mode = try { $env | get $mock_env_var | into bool } catch { false }
    ...
    if $mock_mode {
        # Return mock response
        {
            ...
            message: "Mock response for iam createloginprofile"
        }
    } else {
        # Execute AWS CLI with error handling
        try {
            aws iam createloginprofile | from json
        } catch { |err|
            error make {
                msg: $"AWS CLI error: { $err.msg }",
                label: {
...
export def "aws iam createopenidconnectprovider" []: nothing -> any {
    # Check if in mock mode
    let mock_env_var = "IAM_MOCK_MODE"
    let mock_mode = try { $env | get $mock_env_var | into bool } catch { false }
    ...
    if $mock_mode {
        # Return mock response
        {
            ...
            message: "Mock response for iam createopenidconnectprovider"
        }
    } else {
        # Execute AWS CLI with error handling
        try {
            aws iam createopenidconnectprovider | from json
        } catch { |err|
            error make {
                msg: $"AWS CLI error: { $err.msg }",
                label: {
...
export def "aws iam createpolicy" []: nothing -> any {
    # Check if in mock mode
    let mock_env_var = "IAM_MOCK_MODE"
    let mock_mode = try { $env | get $mock_env_var | into bool } catch { false }
    ...
    if $mock_mode {
        # Return mock response
        {
            ...
            message: "Mock response for iam createpolicy"
        }
    } else {
        # Execute AWS CLI with error handling
        try {
            aws iam createpolicy | from json
        } catch { |err|
            error make {
                msg: $"AWS CLI error: { $err.msg }",
                label: {
...
export def "aws iam createpolicyversion" []: nothing -> any {
    # Check if in mock mode
    let mock_env_var = "IAM_MOCK_MODE"
    let mock_mode = try { $env | get $mock_env_var | into bool } catch { false }
    ...
    if $mock_mode {
        # Return mock response
        {
            ...
            message: "Mock response for iam createpolicyversion"
        }
    } else {
        # Execute AWS CLI with error handling
        try {
            aws iam createpolicyversion | from json
        } catch { |err|
            error make {
                msg: $"AWS CLI error: { $err.msg }",
                label: {
...
export def "aws iam createrole" []: nothing -> any {
    # Check if in mock mode
    let mock_env_var = "IAM_MOCK_MODE"
    let mock_mode = try { $env | get $mock_env_var | into bool } catch { false }
    ...
    if $mock_mode {
        # Return mock response
        {
            ...
            message: "Mock response for iam createrole"
        }
    } else {
        # Execute AWS CLI with error handling
        try {
            aws iam createrole | from json
        } catch { |err|
            error make {
                msg: $"AWS CLI error: { $err.msg }",
                label: {
...
export def "aws iam createsamlprovider" []: nothing -> any {
    # Check if in mock mode
    let mock_env_var = "IAM_MOCK_MODE"
    let mock_mode = try { $env | get $mock_env_var | into bool } catch { false }
    ...
    if $mock_mode {
        # Return mock response
        {
            ...
            message: "Mock response for iam createsamlprovider"
        }
    } else {
        # Execute AWS CLI with error handling
        try {
            aws iam createsamlprovider | from json
        } catch { |err|
            error make {
                msg: $"AWS CLI error: { $err.msg }",
                label: {
...
export def "aws iam createservicelinkedrole" []: nothing -> any {
    # Check if in mock mode
    let mock_env_var = "IAM_MOCK_MODE"
    let mock_mode = try { $env | get $mock_env_var | into bool } catch { false }
    ...
    if $mock_mode {
        # Return mock response
        {
            ...
            message: "Mock response for iam createservicelinkedrole"
        }
    } else {
        # Execute AWS CLI with error handling
        try {
            aws iam createservicelinkedrole | from json
        } catch { |err|
            error make {
                msg: $"AWS CLI error: { $err.msg }",
                label: {
...
export def "aws iam createservicespecificcredential" []: nothing -> any {
    # Check if in mock mode
    let mock_env_var = "IAM_MOCK_MODE"
    let mock_mode = try { $env | get $mock_env_var | into bool } catch { false }
    ...
    if $mock_mode {
        # Return mock response
        {
            ...
            message: "Mock response for iam createservicespecificcredential"
        }
    } else {
        # Execute AWS CLI with error handling
        try {
            aws iam createservicespecificcredential | from json
        } catch { |err|
            error make {
                msg: $"AWS CLI error: { $err.msg }",
                label: {
...
export def "aws iam createuser" []: nothing -> any {
    # Check if in mock mode
    let mock_env_var = "IAM_MOCK_MODE"
    let mock_mode = try { $env | get $mock_env_var | into bool } catch { false }
    ...
    if $mock_mode {
        # Return mock response
        {
            ...
            message: "Mock response for iam createuser"
        }
    } else {
        # Execute AWS CLI with error handling
        try {
            aws iam createuser | from json
        } catch { |err|
            error make {
                msg: $"AWS CLI error: { $err.msg }",
                label: {
...
export def "aws iam createvirtualmfadevice" []: nothing -> any {
    # Check if in mock mode
    let mock_env_var = "IAM_MOCK_MODE"
    let mock_mode = try { $env | get $mock_env_var | into bool } catch { false }
    ...
    if $mock_mode {
        # Return mock response
        {
            ...
            message: "Mock response for iam createvirtualmfadevice"
        }
    } else {
        # Execute AWS CLI with error handling
        try {
            aws iam createvirtualmfadevice | from json
        } catch { |err|
            error make {
                msg: $"AWS CLI error: { $err.msg }",
                label: {
...
export def "aws iam deactivatemfadevice" []: nothing -> any {
    # Check if in mock mode
    let mock_env_var = "IAM_MOCK_MODE"
    let mock_mode = try { $env | get $mock_env_var | into bool } catch { false }
    ...
    if $mock_mode {
        # Return mock response
        {
            ...
            message: "Mock response for iam deactivatemfadevice"
        }
    } else {
        # Execute AWS CLI with error handling
        try {
            aws iam deactivatemfadevice | from json
        } catch { |err|
            error make {
                msg: $"AWS CLI error: { $err.msg }",
                label: {
...
export def "aws iam deleteaccesskey" []: nothing -> any {
    # Check if in mock mode
    let mock_env_var = "IAM_MOCK_MODE"
    let mock_mode = try { $env | get $mock_env_var | into bool } catch { false }
    ...
    if $mock_mode {
        # Return mock response
        {
            ...
            message: "Mock response for iam deleteaccesskey"
        }
    } else {
        # Execute AWS CLI with error handling
        try {
            aws iam deleteaccesskey | from json
        } catch { |err|
            error make {
                msg: $"AWS CLI error: { $err.msg }",
                label: {
...
export def "aws iam deleteaccountalias" []: nothing -> any {
    # Check if in mock mode
    let mock_env_var = "IAM_MOCK_MODE"
    let mock_mode = try { $env | get $mock_env_var | into bool } catch { false }
    ...
    if $mock_mode {
        # Return mock response
        {
            ...
            message: "Mock response for iam deleteaccountalias"
        }
    } else {
        # Execute AWS CLI with error handling
        try {
            aws iam deleteaccountalias | from json
        } catch { |err|
            error make {
                msg: $"AWS CLI error: { $err.msg }",
                label: {
...
export def "aws iam deleteaccountpasswordpolicy" []: nothing -> any {
    # Check if in mock mode
    let mock_env_var = "IAM_MOCK_MODE"
    let mock_mode = try { $env | get $mock_env_var | into bool } catch { false }
    ...
    if $mock_mode {
        # Return mock response
        {
            ...
            message: "Mock response for iam deleteaccountpasswordpolicy"
        }
    } else {
        # Execute AWS CLI with error handling
        try {
            aws iam deleteaccountpasswordpolicy | from json
        } catch { |err|
            error make {
                msg: $"AWS CLI error: { $err.msg }",
                label: {
...
export def "aws iam deletegroup" []: nothing -> any {
    # Check if in mock mode
    let mock_env_var = "IAM_MOCK_MODE"
    let mock_mode = try { $env | get $mock_env_var | into bool } catch { false }
    ...
    if $mock_mode {
        # Return mock response
        {
            ...
            message: "Mock response for iam deletegroup"
        }
    } else {
        # Execute AWS CLI with error handling
        try {
            aws iam deletegroup | from json
        } catch { |err|
            error make {
                msg: $"AWS CLI error: { $err.msg }",
                label: {
...
export def "aws iam deletegrouppolicy" []: nothing -> any {
    # Check if in mock mode
    let mock_env_var = "IAM_MOCK_MODE"
    let mock_mode = try { $env | get $mock_env_var | into bool } catch { false }
    ...
    if $mock_mode {
        # Return mock response
        {
            ...
            message: "Mock response for iam deletegrouppolicy"
        }
    } else {
        # Execute AWS CLI with error handling
        try {
            aws iam deletegrouppolicy | from json
        } catch { |err|
            error make {
                msg: $"AWS CLI error: { $err.msg }",
                label: {
...
export def "aws iam deleteinstanceprofile" []: nothing -> any {
    # Check if in mock mode
    let mock_env_var = "IAM_MOCK_MODE"
    let mock_mode = try { $env | get $mock_env_var | into bool } catch { false }
    ...
    if $mock_mode {
        # Return mock response
        {
            ...
            message: "Mock response for iam deleteinstanceprofile"
        }
    } else {
        # Execute AWS CLI with error handling
        try {
            aws iam deleteinstanceprofile | from json
        } catch { |err|
            error make {
                msg: $"AWS CLI error: { $err.msg }",
                label: {
...
export def "aws iam deleteloginprofile" []: nothing -> any {
    # Check if in mock mode
    let mock_env_var = "IAM_MOCK_MODE"
    let mock_mode = try { $env | get $mock_env_var | into bool } catch { false }
    ...
    if $mock_mode {
        # Return mock response
        {
            ...
            message: "Mock response for iam deleteloginprofile"
        }
    } else {
        # Execute AWS CLI with error handling
        try {
            aws iam deleteloginprofile | from json
        } catch { |err|
            error make {
                msg: $"AWS CLI error: { $err.msg }",
                label: {
...
export def "aws iam deleteopenidconnectprovider" []: nothing -> any {
    # Check if in mock mode
    let mock_env_var = "IAM_MOCK_MODE"
    let mock_mode = try { $env | get $mock_env_var | into bool } catch { false }
    ...
    if $mock_mode {
        # Return mock response
        {
            ...
            message: "Mock response for iam deleteopenidconnectprovider"
        }
    } else {
        # Execute AWS CLI with error handling
        try {
            aws iam deleteopenidconnectprovider | from json
        } catch { |err|
            error make {
                msg: $"AWS CLI error: { $err.msg }",
                label: {
...
export def "aws iam deletepolicy" []: nothing -> any {
    # Check if in mock mode
    let mock_env_var = "IAM_MOCK_MODE"
    let mock_mode = try { $env | get $mock_env_var | into bool } catch { false }
    ...
    if $mock_mode {
        # Return mock response
        {
            ...
            message: "Mock response for iam deletepolicy"
        }
    } else {
        # Execute AWS CLI with error handling
        try {
            aws iam deletepolicy | from json
        } catch { |err|
            error make {
                msg: $"AWS CLI error: { $err.msg }",
                label: {
...
export def "aws iam deletepolicyversion" []: nothing -> any {
    # Check if in mock mode
    let mock_env_var = "IAM_MOCK_MODE"
    let mock_mode = try { $env | get $mock_env_var | into bool } catch { false }
    ...
    if $mock_mode {
        # Return mock response
        {
            ...
            message: "Mock response for iam deletepolicyversion"
        }
    } else {
        # Execute AWS CLI with error handling
        try {
            aws iam deletepolicyversion | from json
        } catch { |err|
            error make {
                msg: $"AWS CLI error: { $err.msg }",
                label: {
...
export def "aws iam deleterole" []: nothing -> any {
    # Check if in mock mode
    let mock_env_var = "IAM_MOCK_MODE"
    let mock_mode = try { $env | get $mock_env_var | into bool } catch { false }
    ...
    if $mock_mode {
        # Return mock response
        {
            ...
            message: "Mock response for iam deleterole"
        }
    } else {
        # Execute AWS CLI with error handling
        try {
            aws iam deleterole | from json
        } catch { |err|
            error make {
                msg: $"AWS CLI error: { $err.msg }",
                label: {
...
export def "aws iam deleterolepermissionsboundary" []: nothing -> any {
    # Check if in mock mode
    let mock_env_var = "IAM_MOCK_MODE"
    let mock_mode = try { $env | get $mock_env_var | into bool } catch { false }
    ...
    if $mock_mode {
        # Return mock response
        {
            ...
            message: "Mock response for iam deleterolepermissionsboundary"
        }
    } else {
        # Execute AWS CLI with error handling
        try {
            aws iam deleterolepermissionsboundary | from json
        } catch { |err|
            error make {
                msg: $"AWS CLI error: { $err.msg }",
                label: {
...
export def "aws iam deleterolepolicy" []: nothing -> any {
    # Check if in mock mode
    let mock_env_var = "IAM_MOCK_MODE"
    let mock_mode = try { $env | get $mock_env_var | into bool } catch { false }
    ...
    if $mock_mode {
        # Return mock response
        {
            ...
            message: "Mock response for iam deleterolepolicy"
        }
    } else {
        # Execute AWS CLI with error handling
        try {
            aws iam deleterolepolicy | from json
        } catch { |err|
            error make {
                msg: $"AWS CLI error: { $err.msg }",
                label: {
...
export def "aws iam deletesamlprovider" []: nothing -> any {
    # Check if in mock mode
    let mock_env_var = "IAM_MOCK_MODE"
    let mock_mode = try { $env | get $mock_env_var | into bool } catch { false }
    ...
    if $mock_mode {
        # Return mock response
        {
            ...
            message: "Mock response for iam deletesamlprovider"
        }
    } else {
        # Execute AWS CLI with error handling
        try {
            aws iam deletesamlprovider | from json
        } catch { |err|
            error make {
                msg: $"AWS CLI error: { $err.msg }",
                label: {
...
export def "aws iam deletesshpublickey" []: nothing -> any {
    # Check if in mock mode
    let mock_env_var = "IAM_MOCK_MODE"
    let mock_mode = try { $env | get $mock_env_var | into bool } catch { false }
    ...
    if $mock_mode {
        # Return mock response
        {
            ...
            message: "Mock response for iam deletesshpublickey"
        }
    } else {
        # Execute AWS CLI with error handling
        try {
            aws iam deletesshpublickey | from json
        } catch { |err|
            error make {
                msg: $"AWS CLI error: { $err.msg }",
                label: {
...
export def "aws iam deleteservercertificate" []: nothing -> any {
    # Check if in mock mode
    let mock_env_var = "IAM_MOCK_MODE"
    let mock_mode = try { $env | get $mock_env_var | into bool } catch { false }
    ...
    if $mock_mode {
        # Return mock response
        {
            ...
            message: "Mock response for iam deleteservercertificate"
        }
    } else {
        # Execute AWS CLI with error handling
        try {
            aws iam deleteservercertificate | from json
        } catch { |err|
            error make {
                msg: $"AWS CLI error: { $err.msg }",
                label: {
...
export def "aws iam deleteservicelinkedrole" []: nothing -> any {
    # Check if in mock mode
    let mock_env_var = "IAM_MOCK_MODE"
    let mock_mode = try { $env | get $mock_env_var | into bool } catch { false }
    ...
    if $mock_mode {
        # Return mock response
        {
            ...
            message: "Mock response for iam deleteservicelinkedrole"
        }
    } else {
        # Execute AWS CLI with error handling
        try {
            aws iam deleteservicelinkedrole | from json
        } catch { |err|
            error make {
                msg: $"AWS CLI error: { $err.msg }",
                label: {
...
export def "aws iam deleteservicespecificcredential" []: nothing -> any {
    # Check if in mock mode
    let mock_env_var = "IAM_MOCK_MODE"
    let mock_mode = try { $env | get $mock_env_var | into bool } catch { false }
    ...
    if $mock_mode {
        # Return mock response
        {
            ...
            message: "Mock response for iam deleteservicespecificcredential"
        }
    } else {
        # Execute AWS CLI with error handling
        try {
            aws iam deleteservicespecificcredential | from json
        } catch { |err|
            error make {
                msg: $"AWS CLI error: { $err.msg }",
                label: {
...
export def "aws iam deletesigningcertificate" []: nothing -> any {
    # Check if in mock mode
    let mock_env_var = "IAM_MOCK_MODE"
    let mock_mode = try { $env | get $mock_env_var | into bool } catch { false }
    ...
    if $mock_mode {
        # Return mock response
        {
            ...
            message: "Mock response for iam deletesigningcertificate"
        }
    } else {
        # Execute AWS CLI with error handling
        try {
            aws iam deletesigningcertificate | from json
        } catch { |err|
            error make {
                msg: $"AWS CLI error: { $err.msg }",
                label: {
...
export def "aws iam deleteuser" []: nothing -> any {
    # Check if in mock mode
    let mock_env_var = "IAM_MOCK_MODE"
    let mock_mode = try { $env | get $mock_env_var | into bool } catch { false }
    ...
    if $mock_mode {
        # Return mock response
        {
            ...
            message: "Mock response for iam deleteuser"
        }
    } else {
        # Execute AWS CLI with error handling
        try {
            aws iam deleteuser | from json
        } catch { |err|
            error make {
                msg: $"AWS CLI error: { $err.msg }",
                label: {
...
export def "aws iam deleteuserpermissionsboundary" []: nothing -> any {
    # Check if in mock mode
    let mock_env_var = "IAM_MOCK_MODE"
    let mock_mode = try { $env | get $mock_env_var | into bool } catch { false }
    ...
    if $mock_mode {
        # Return mock response
        {
            ...
            message: "Mock response for iam deleteuserpermissionsboundary"
        }
    } else {
        # Execute AWS CLI with error handling
        try {
            aws iam deleteuserpermissionsboundary | from json
        } catch { |err|
            error make {
                msg: $"AWS CLI error: { $err.msg }",
                label: {
...
export def "aws iam deleteuserpolicy" []: nothing -> any {
    # Check if in mock mode
    let mock_env_var = "IAM_MOCK_MODE"
    let mock_mode = try { $env | get $mock_env_var | into bool } catch { false }
    ...
    if $mock_mode {
        # Return mock response
        {
            ...
            message: "Mock response for iam deleteuserpolicy"
        }
    } else {
        # Execute AWS CLI with error handling
        try {
            aws iam deleteuserpolicy | from json
        } catch { |err|
            error make {
                msg: $"AWS CLI error: { $err.msg }",
                label: {
...
export def "aws iam deletevirtualmfadevice" []: nothing -> any {
    # Check if in mock mode
    let mock_env_var = "IAM_MOCK_MODE"
    let mock_mode = try { $env | get $mock_env_var | into bool } catch { false }
    ...
    if $mock_mode {
        # Return mock response
        {
            ...
            message: "Mock response for iam deletevirtualmfadevice"
        }
    } else {
        # Execute AWS CLI with error handling
        try {
            aws iam deletevirtualmfadevice | from json
        } catch { |err|
            error make {
                msg: $"AWS CLI error: { $err.msg }",
                label: {
...
export def "aws iam detachgrouppolicy" []: nothing -> any {
    # Check if in mock mode
    let mock_env_var = "IAM_MOCK_MODE"
    let mock_mode = try { $env | get $mock_env_var | into bool } catch { false }
    ...
    if $mock_mode {
        # Return mock response
        {
            ...
            message: "Mock response for iam detachgrouppolicy"
        }
    } else {
        # Execute AWS CLI with error handling
        try {
            aws iam detachgrouppolicy | from json
        } catch { |err|
            error make {
                msg: $"AWS CLI error: { $err.msg }",
                label: {
...
export def "aws iam detachrolepolicy" []: nothing -> any {
    # Check if in mock mode
    let mock_env_var = "IAM_MOCK_MODE"
    let mock_mode = try { $env | get $mock_env_var | into bool } catch { false }
    ...
    if $mock_mode {
        # Return mock response
        {
            ...
            message: "Mock response for iam detachrolepolicy"
        }
    } else {
        # Execute AWS CLI with error handling
        try {
            aws iam detachrolepolicy | from json
        } catch { |err|
            error make {
                msg: $"AWS CLI error: { $err.msg }",
                label: {
...
export def "aws iam detachuserpolicy" []: nothing -> any {
    # Check if in mock mode
    let mock_env_var = "IAM_MOCK_MODE"
    let mock_mode = try { $env | get $mock_env_var | into bool } catch { false }
    ...
    if $mock_mode {
        # Return mock response
        {
            ...
            message: "Mock response for iam detachuserpolicy"
        }
    } else {
        # Execute AWS CLI with error handling
        try {
            aws iam detachuserpolicy | from json
        } catch { |err|
            error make {
                msg: $"AWS CLI error: { $err.msg }",
                label: {
...
export def "aws iam disableorganizationsrootcredentialsmanagement" []: nothing -> any {
    # Check if in mock mode
    let mock_env_var = "IAM_MOCK_MODE"
    let mock_mode = try { $env | get $mock_env_var | into bool } catch { false }
    ...
    if $mock_mode {
        # Return mock response
        {
            ...
            message: "Mock response for iam disableorganizationsrootcredentialsmanagement"
        }
    } else {
        # Execute AWS CLI with error handling
        try {
            aws iam disableorganizationsrootcredentialsmanagement | from json
        } catch { |err|
            error make {
                msg: $"AWS CLI error: { $err.msg }",
                label: {
...
export def "aws iam disableorganizationsrootsessions" []: nothing -> any {
    # Check if in mock mode
    let mock_env_var = "IAM_MOCK_MODE"
    let mock_mode = try { $env | get $mock_env_var | into bool } catch { false }
    ...
    if $mock_mode {
        # Return mock response
        {
            ...
            message: "Mock response for iam disableorganizationsrootsessions"
        }
    } else {
        # Execute AWS CLI with error handling
        try {
            aws iam disableorganizationsrootsessions | from json
        } catch { |err|
            error make {
                msg: $"AWS CLI error: { $err.msg }",
                label: {
...
export def "aws iam enablemfadevice" []: nothing -> any {
    # Check if in mock mode
    let mock_env_var = "IAM_MOCK_MODE"
    let mock_mode = try { $env | get $mock_env_var | into bool } catch { false }
    ...
    if $mock_mode {
        # Return mock response
        {
            ...
            message: "Mock response for iam enablemfadevice"
        }
    } else {
        # Execute AWS CLI with error handling
        try {
            aws iam enablemfadevice | from json
        } catch { |err|
            error make {
                msg: $"AWS CLI error: { $err.msg }",
                label: {
...
export def "aws iam enableorganizationsrootcredentialsmanagement" []: nothing -> any {
    # Check if in mock mode
    let mock_env_var = "IAM_MOCK_MODE"
    let mock_mode = try { $env | get $mock_env_var | into bool } catch { false }
    ...
    if $mock_mode {
        # Return mock response
        {
            ...
            message: "Mock response for iam enableorganizationsrootcredentialsmanagement"
        }
    } else {
        # Execute AWS CLI with error handling
        try {
            aws iam enableorganizationsrootcredentialsmanagement | from json
        } catch { |err|
            error make {
                msg: $"AWS CLI error: { $err.msg }",
                label: {
...
export def "aws iam enableorganizationsrootsessions" []: nothing -> any {
    # Check if in mock mode
    let mock_env_var = "IAM_MOCK_MODE"
    let mock_mode = try { $env | get $mock_env_var | into bool } catch { false }
    ...
    if $mock_mode {
        # Return mock response
        {
            ...
            message: "Mock response for iam enableorganizationsrootsessions"
        }
    } else {
        # Execute AWS CLI with error handling
        try {
            aws iam enableorganizationsrootsessions | from json
        } catch { |err|
            error make {
                msg: $"AWS CLI error: { $err.msg }",
                label: {
...
export def "aws iam generatecredentialreport" []: nothing -> any {
    # Check if in mock mode
    let mock_env_var = "IAM_MOCK_MODE"
    let mock_mode = try { $env | get $mock_env_var | into bool } catch { false }
    ...
    if $mock_mode {
        # Return mock response
        {
            ...
            message: "Mock response for iam generatecredentialreport"
        }
    } else {
        # Execute AWS CLI with error handling
        try {
            aws iam generatecredentialreport | from json
        } catch { |err|
            error make {
                msg: $"AWS CLI error: { $err.msg }",
                label: {
...
export def "aws iam generateorganizationsaccessreport" []: nothing -> any {
    # Check if in mock mode
    let mock_env_var = "IAM_MOCK_MODE"
    let mock_mode = try { $env | get $mock_env_var | into bool } catch { false }
    ...
    if $mock_mode {
        # Return mock response
        {
            ...
            message: "Mock response for iam generateorganizationsaccessreport"
        }
    } else {
        # Execute AWS CLI with error handling
        try {
            aws iam generateorganizationsaccessreport | from json
        } catch { |err|
            error make {
                msg: $"AWS CLI error: { $err.msg }",
                label: {
...
export def "aws iam generateservicelastaccesseddetails" []: nothing -> any {
    # Check if in mock mode
    let mock_env_var = "IAM_MOCK_MODE"
    let mock_mode = try { $env | get $mock_env_var | into bool } catch { false }
    ...
    if $mock_mode {
        # Return mock response
        {
            ...
            message: "Mock response for iam generateservicelastaccesseddetails"
        }
    } else {
        # Execute AWS CLI with error handling
        try {
            aws iam generateservicelastaccesseddetails | from json
        } catch { |err|
            error make {
                msg: $"AWS CLI error: { $err.msg }",
                label: {
...
export def "aws iam getaccesskeylastused" []: nothing -> any {
    # Check if in mock mode
    let mock_env_var = "IAM_MOCK_MODE"
    let mock_mode = try { $env | get $mock_env_var | into bool } catch { false }
    ...
    if $mock_mode {
        # Return mock response
        {
            ...
            message: "Mock response for iam getaccesskeylastused"
        }
    } else {
        # Execute AWS CLI with error handling
        try {
            aws iam getaccesskeylastused | from json
        } catch { |err|
            error make {
                msg: $"AWS CLI error: { $err.msg }",
                label: {
...
export def "aws iam getaccountauthorizationdetails" []: nothing -> any {
    # Check if in mock mode
    let mock_env_var = "IAM_MOCK_MODE"
    let mock_mode = try { $env | get $mock_env_var | into bool } catch { false }
    ...
    if $mock_mode {
        # Return mock response
        {
            ...
            message: "Mock response for iam getaccountauthorizationdetails"
        }
    } else {
        # Execute AWS CLI with error handling
        try {
            aws iam getaccountauthorizationdetails | from json
        } catch { |err|
            error make {
                msg: $"AWS CLI error: { $err.msg }",
                label: {
...
export def "aws iam getaccountpasswordpolicy" []: nothing -> any {
    # Check if in mock mode
    let mock_env_var = "IAM_MOCK_MODE"
    let mock_mode = try { $env | get $mock_env_var | into bool } catch { false }
    ...
    if $mock_mode {
        # Return mock response
        {
            ...
            message: "Mock response for iam getaccountpasswordpolicy"
        }
    } else {
        # Execute AWS CLI with error handling
        try {
            aws iam getaccountpasswordpolicy | from json
        } catch { |err|
            error make {
                msg: $"AWS CLI error: { $err.msg }",
                label: {
...
export def "aws iam getaccountsummary" []: nothing -> any {
    # Check if in mock mode
    let mock_env_var = "IAM_MOCK_MODE"
    let mock_mode = try { $env | get $mock_env_var | into bool } catch { false }
    ...
    if $mock_mode {
        # Return mock response
        {
            ...
            message: "Mock response for iam getaccountsummary"
        }
    } else {
        # Execute AWS CLI with error handling
        try {
            aws iam getaccountsummary | from json
        } catch { |err|
            error make {
                msg: $"AWS CLI error: { $err.msg }",
                label: {
...
export def "aws iam getcontextkeysforcustompolicy" []: nothing -> any {
    # Check if in mock mode
    let mock_env_var = "IAM_MOCK_MODE"
    let mock_mode = try { $env | get $mock_env_var | into bool } catch { false }
    ...
    if $mock_mode {
        # Return mock response
        {
            ...
            message: "Mock response for iam getcontextkeysforcustompolicy"
        }
    } else {
        # Execute AWS CLI with error handling
        try {
            aws iam getcontextkeysforcustompolicy | from json
        } catch { |err|
            error make {
                msg: $"AWS CLI error: { $err.msg }",
                label: {
...
export def "aws iam getcontextkeysforprincipalpolicy" []: nothing -> any {
    # Check if in mock mode
    let mock_env_var = "IAM_MOCK_MODE"
    let mock_mode = try { $env | get $mock_env_var | into bool } catch { false }
    ...
    if $mock_mode {
        # Return mock response
        {
            ...
            message: "Mock response for iam getcontextkeysforprincipalpolicy"
        }
    } else {
        # Execute AWS CLI with error handling
        try {
            aws iam getcontextkeysforprincipalpolicy | from json
        } catch { |err|
            error make {
                msg: $"AWS CLI error: { $err.msg }",
                label: {
...
export def "aws iam getcredentialreport" []: nothing -> any {
    # Check if in mock mode
    let mock_env_var = "IAM_MOCK_MODE"
    let mock_mode = try { $env | get $mock_env_var | into bool } catch { false }
    ...
    if $mock_mode {
        # Return mock response
        {
            ...
            message: "Mock response for iam getcredentialreport"
        }
    } else {
        # Execute AWS CLI with error handling
        try {
            aws iam getcredentialreport | from json
        } catch { |err|
            error make {
                msg: $"AWS CLI error: { $err.msg }",
                label: {
...
export def "aws iam getgroup" []: nothing -> any {
    # Check if in mock mode
    let mock_env_var = "IAM_MOCK_MODE"
    let mock_mode = try { $env | get $mock_env_var | into bool } catch { false }
    ...
    if $mock_mode {
        # Return mock response
        {
            ...
            service: "iam",
            operation: "getgroup",
            message: "Mock response for iam getgroup"
        }
    } else {
        # Execute AWS CLI with error handling
        try {
            aws iam getgroup | from json
        } catch { |err|
            error make {
                msg: $"AWS CLI error: { $err.msg }",
                label: {
...
export def "aws iam getgrouppolicy" []: nothing -> any {
    # Check if in mock mode
    let mock_env_var = "IAM_MOCK_MODE"
    let mock_mode = try { $env | get $mock_env_var | into bool } catch { false }
    ...
    if $mock_mode {
        # Return mock response
        {
            ...
            message: "Mock response for iam getgrouppolicy"
        }
    } else {
        # Execute AWS CLI with error handling
        try {
            aws iam getgrouppolicy | from json
        } catch { |err|
            error make {
                msg: $"AWS CLI error: { $err.msg }",
                label: {
...
export def "aws iam getinstanceprofile" []: nothing -> any {
    # Check if in mock mode
    let mock_env_var = "IAM_MOCK_MODE"
    let mock_mode = try { $env | get $mock_env_var | into bool } catch { false }
    ...
    if $mock_mode {
        # Return mock response
        {
            ...
            message: "Mock response for iam getinstanceprofile"
        }
    } else {
        # Execute AWS CLI with error handling
        try {
            aws iam getinstanceprofile | from json
        } catch { |err|
            error make {
                msg: $"AWS CLI error: { $err.msg }",
                label: {
...
export def "aws iam getloginprofile" []: nothing -> any {
    # Check if in mock mode
    let mock_env_var = "IAM_MOCK_MODE"
    let mock_mode = try { $env | get $mock_env_var | into bool } catch { false }
    ...
    if $mock_mode {
        # Return mock response
        {
            ...
            message: "Mock response for iam getloginprofile"
        }
    } else {
        # Execute AWS CLI with error handling
        try {
            aws iam getloginprofile | from json
        } catch { |err|
            error make {
                msg: $"AWS CLI error: { $err.msg }",
                label: {
...
export def "aws iam getmfadevice" []: nothing -> any {
    # Check if in mock mode
    let mock_env_var = "IAM_MOCK_MODE"
    let mock_mode = try { $env | get $mock_env_var | into bool } catch { false }
    ...
    if $mock_mode {
        # Return mock response
        {
            ...
            message: "Mock response for iam getmfadevice"
        }
    } else {
        # Execute AWS CLI with error handling
        try {
            aws iam getmfadevice | from json
        } catch { |err|
            error make {
                msg: $"AWS CLI error: { $err.msg }",
                label: {
...
export def "aws iam getopenidconnectprovider" []: nothing -> any {
    # Check if in mock mode
    let mock_env_var = "IAM_MOCK_MODE"
    let mock_mode = try { $env | get $mock_env_var | into bool } catch { false }
    ...
    if $mock_mode {
        # Return mock response
        {
            ...
            message: "Mock response for iam getopenidconnectprovider"
        }
    } else {
        # Execute AWS CLI with error handling
        try {
            aws iam getopenidconnectprovider | from json
        } catch { |err|
            error make {
                msg: $"AWS CLI error: { $err.msg }",
                label: {
...
export def "aws iam getorganizationsaccessreport" []: nothing -> any {
    # Check if in mock mode
    let mock_env_var = "IAM_MOCK_MODE"
    let mock_mode = try { $env | get $mock_env_var | into bool } catch { false }
    ...
    if $mock_mode {
        # Return mock response
        {
            ...
            message: "Mock response for iam getorganizationsaccessreport"
        }
    } else {
        # Execute AWS CLI with error handling
        try {
            aws iam getorganizationsaccessreport | from json
        } catch { |err|
            error make {
                msg: $"AWS CLI error: { $err.msg }",
                label: {
...
export def "aws iam getpolicy" []: nothing -> any {
    # Check if in mock mode
    let mock_env_var = "IAM_MOCK_MODE"
    let mock_mode = try { $env | get $mock_env_var | into bool } catch { false }
    ...
    if $mock_mode {
        # Return mock response
        {
            ...
            service: "iam",
            operation: "getpolicy",
            message: "Mock response for iam getpolicy"
        }
    } else {
        # Execute AWS CLI with error handling
        try {
            aws iam getpolicy | from json
        } catch { |err|
            error make {
                msg: $"AWS CLI error: { $err.msg }",
                label: {
...
export def "aws iam getpolicyversion" []: nothing -> any {
    # Check if in mock mode
    let mock_env_var = "IAM_MOCK_MODE"
    let mock_mode = try { $env | get $mock_env_var | into bool } catch { false }
    ...
    if $mock_mode {
        # Return mock response
        {
            ...
            message: "Mock response for iam getpolicyversion"
        }
    } else {
        # Execute AWS CLI with error handling
        try {
            aws iam getpolicyversion | from json
        } catch { |err|
            error make {
                msg: $"AWS CLI error: { $err.msg }",
                label: {
...
export def "aws iam getrole" []: nothing -> any {
    # Check if in mock mode
    let mock_env_var = "IAM_MOCK_MODE"
    let mock_mode = try { $env | get $mock_env_var | into bool } catch { false }
    ...
    if $mock_mode {
        # Return mock response
        {
            ...
            service: "iam",
            operation: "getrole",
            message: "Mock response for iam getrole"
        }
    } else {
        # Execute AWS CLI with error handling
        try {
            aws iam getrole | from json
        } catch { |err|
            error make {
                msg: $"AWS CLI error: { $err.msg }",
                label: {
...
export def "aws iam getrolepolicy" []: nothing -> any {
    # Check if in mock mode
    let mock_env_var = "IAM_MOCK_MODE"
    let mock_mode = try { $env | get $mock_env_var | into bool } catch { false }
    ...
    if $mock_mode {
        # Return mock response
        {
            ...
            message: "Mock response for iam getrolepolicy"
        }
    } else {
        # Execute AWS CLI with error handling
        try {
            aws iam getrolepolicy | from json
        } catch { |err|
            error make {
                msg: $"AWS CLI error: { $err.msg }",
                label: {
...
export def "aws iam getsamlprovider" []: nothing -> any {
    # Check if in mock mode
    let mock_env_var = "IAM_MOCK_MODE"
    let mock_mode = try { $env | get $mock_env_var | into bool } catch { false }
    ...
    if $mock_mode {
        # Return mock response
        {
            ...
            message: "Mock response for iam getsamlprovider"
        }
    } else {
        # Execute AWS CLI with error handling
        try {
            aws iam getsamlprovider | from json
        } catch { |err|
            error make {
                msg: $"AWS CLI error: { $err.msg }",
                label: {
...
export def "aws iam getsshpublickey" []: nothing -> any {
    # Check if in mock mode
    let mock_env_var = "IAM_MOCK_MODE"
    let mock_mode = try { $env | get $mock_env_var | into bool } catch { false }
    ...
    if $mock_mode {
        # Return mock response
        {
            ...
            message: "Mock response for iam getsshpublickey"
        }
    } else {
        # Execute AWS CLI with error handling
        try {
            aws iam getsshpublickey | from json
        } catch { |err|
            error make {
                msg: $"AWS CLI error: { $err.msg }",
                label: {
...
export def "aws iam getservercertificate" []: nothing -> any {
    # Check if in mock mode
    let mock_env_var = "IAM_MOCK_MODE"
    let mock_mode = try { $env | get $mock_env_var | into bool } catch { false }
    ...
    if $mock_mode {
        # Return mock response
        {
            ...
            message: "Mock response for iam getservercertificate"
        }
    } else {
        # Execute AWS CLI with error handling
        try {
            aws iam getservercertificate | from json
        } catch { |err|
            error make {
                msg: $"AWS CLI error: { $err.msg }",
                label: {
...
export def "aws iam getservicelastaccesseddetails" []: nothing -> any {
    # Check if in mock mode
    let mock_env_var = "IAM_MOCK_MODE"
    let mock_mode = try { $env | get $mock_env_var | into bool } catch { false }
    ...
    if $mock_mode {
        # Return mock response
        {
            ...
            message: "Mock response for iam getservicelastaccesseddetails"
        }
    } else {
        # Execute AWS CLI with error handling
        try {
            aws iam getservicelastaccesseddetails | from json
        } catch { |err|
            error make {
                msg: $"AWS CLI error: { $err.msg }",
                label: {
...
export def "aws iam getservicelastaccesseddetailswithentities" []: nothing -> any {
    # Check if in mock mode
    let mock_env_var = "IAM_MOCK_MODE"
    let mock_mode = try { $env | get $mock_env_var | into bool } catch { false }
    ...
    if $mock_mode {
        # Return mock response
        {
            ...
            message: "Mock response for iam getservicelastaccesseddetailswithentities"
        }
    } else {
        # Execute AWS CLI with error handling
        try {
            aws iam getservicelastaccesseddetailswithentities | from json
        } catch { |err|
            error make {
                msg: $"AWS CLI error: { $err.msg }",
                label: {
...
export def "aws iam getservicelinkedroledeletionstatus" []: nothing -> any {
    # Check if in mock mode
    let mock_env_var = "IAM_MOCK_MODE"
    let mock_mode = try { $env | get $mock_env_var | into bool } catch { false }
    ...
    if $mock_mode {
        # Return mock response
        {
            ...
            message: "Mock response for iam getservicelinkedroledeletionstatus"
        }
    } else {
        # Execute AWS CLI with error handling
        try {
            aws iam getservicelinkedroledeletionstatus | from json
        } catch { |err|
            error make {
                msg: $"AWS CLI error: { $err.msg }",
                label: {
...
export def "aws iam getuser" []: nothing -> any {
    # Check if in mock mode
    let mock_env_var = "IAM_MOCK_MODE"
    let mock_mode = try { $env | get $mock_env_var | into bool } catch { false }
    ...
    if $mock_mode {
        # Return mock response
        {
            ...
            service: "iam",
            operation: "getuser",
            message: "Mock response for iam getuser"
        }
    } else {
        # Execute AWS CLI with error handling
        try {
            aws iam getuser | from json
        } catch { |err|
            error make {
                msg: $"AWS CLI error: { $err.msg }",
                label: {
...
export def "aws iam getuserpolicy" []: nothing -> any {
    # Check if in mock mode
    let mock_env_var = "IAM_MOCK_MODE"
    let mock_mode = try { $env | get $mock_env_var | into bool } catch { false }
    ...
    if $mock_mode {
        # Return mock response
        {
            ...
            message: "Mock response for iam getuserpolicy"
        }
    } else {
        # Execute AWS CLI with error handling
        try {
            aws iam getuserpolicy | from json
        } catch { |err|
            error make {
                msg: $"AWS CLI error: { $err.msg }",
                label: {
...
export def "aws iam listaccesskeys" []: nothing -> any {
    # Check if in mock mode
    let mock_env_var = "IAM_MOCK_MODE"
    let mock_mode = try { $env | get $mock_env_var | into bool } catch { false }
    ...
    if $mock_mode {
        # Return mock response
        {
            ...
            message: "Mock response for iam listaccesskeys"
        }
    } else {
        # Execute AWS CLI with error handling
        try {
            aws iam listaccesskeys | from json
        } catch { |err|
            error make {
                msg: $"AWS CLI error: { $err.msg }",
                label: {
...
export def "aws iam listaccountaliases" []: nothing -> any {
    # Check if in mock mode
    let mock_env_var = "IAM_MOCK_MODE"
    let mock_mode = try { $env | get $mock_env_var | into bool } catch { false }
    ...
    if $mock_mode {
        # Return mock response
        {
            ...
            message: "Mock response for iam listaccountaliases"
        }
    } else {
        # Execute AWS CLI with error handling
        try {
            aws iam listaccountaliases | from json
        } catch { |err|
            error make {
                msg: $"AWS CLI error: { $err.msg }",
                label: {
...
export def "aws iam listattachedgrouppolicies" []: nothing -> any {
    # Check if in mock mode
    let mock_env_var = "IAM_MOCK_MODE"
    let mock_mode = try { $env | get $mock_env_var | into bool } catch { false }
    ...
    if $mock_mode {
        # Return mock response
        {
            ...
            message: "Mock response for iam listattachedgrouppolicies"
        }
    } else {
        # Execute AWS CLI with error handling
        try {
            aws iam listattachedgrouppolicies | from json
        } catch { |err|
            error make {
                msg: $"AWS CLI error: { $err.msg }",
                label: {
...
export def "aws iam listattachedrolepolicies" []: nothing -> any {
    # Check if in mock mode
    let mock_env_var = "IAM_MOCK_MODE"
    let mock_mode = try { $env | get $mock_env_var | into bool } catch { false }
    ...
    if $mock_mode {
        # Return mock response
        {
            ...
            message: "Mock response for iam listattachedrolepolicies"
        }
    } else {
        # Execute AWS CLI with error handling
        try {
            aws iam listattachedrolepolicies | from json
        } catch { |err|
            error make {
                msg: $"AWS CLI error: { $err.msg }",
                label: {
...
export def "aws iam listattacheduserpolicies" []: nothing -> any {
    # Check if in mock mode
    let mock_env_var = "IAM_MOCK_MODE"
    let mock_mode = try { $env | get $mock_env_var | into bool } catch { false }
    ...
    if $mock_mode {
        # Return mock response
        {
            ...
            message: "Mock response for iam listattacheduserpolicies"
        }
    } else {
        # Execute AWS CLI with error handling
        try {
            aws iam listattacheduserpolicies | from json
        } catch { |err|
            error make {
                msg: $"AWS CLI error: { $err.msg }",
                label: {
...
export def "aws iam listentitiesforpolicy" []: nothing -> any {
    # Check if in mock mode
    let mock_env_var = "IAM_MOCK_MODE"
    let mock_mode = try { $env | get $mock_env_var | into bool } catch { false }
    ...
    if $mock_mode {
        # Return mock response
        {
            ...
            message: "Mock response for iam listentitiesforpolicy"
        }
    } else {
        # Execute AWS CLI with error handling
        try {
            aws iam listentitiesforpolicy | from json
        } catch { |err|
            error make {
                msg: $"AWS CLI error: { $err.msg }",
                label: {
...
export def "aws iam listgrouppolicies" []: nothing -> any {
    # Check if in mock mode
    let mock_env_var = "IAM_MOCK_MODE"
    let mock_mode = try { $env | get $mock_env_var | into bool } catch { false }
    ...
    if $mock_mode {
        # Return mock response
        {
            ...
            message: "Mock response for iam listgrouppolicies"
        }
    } else {
        # Execute AWS CLI with error handling
        try {
            aws iam listgrouppolicies | from json
        } catch { |err|
            error make {
                msg: $"AWS CLI error: { $err.msg }",
                label: {
...
export def "aws iam listgroups" []: nothing -> any {
    # Check if in mock mode
    let mock_env_var = "IAM_MOCK_MODE"
    let mock_mode = try { $env | get $mock_env_var | into bool } catch { false }
    ...
    if $mock_mode {
        # Return mock response
        {
            ...
            message: "Mock response for iam listgroups"
        }
    } else {
        # Execute AWS CLI with error handling
        try {
            aws iam listgroups | from json
        } catch { |err|
            error make {
                msg: $"AWS CLI error: { $err.msg }",
                label: {
...
export def "aws iam listgroupsforuser" []: nothing -> any {
    # Check if in mock mode
    let mock_env_var = "IAM_MOCK_MODE"
    let mock_mode = try { $env | get $mock_env_var | into bool } catch { false }
    ...
    if $mock_mode {
        # Return mock response
        {
            ...
            message: "Mock response for iam listgroupsforuser"
        }
    } else {
        # Execute AWS CLI with error handling
        try {
            aws iam listgroupsforuser | from json
        } catch { |err|
            error make {
                msg: $"AWS CLI error: { $err.msg }",
                label: {
...
export def "aws iam listinstanceprofiletags" []: nothing -> any {
    # Check if in mock mode
    let mock_env_var = "IAM_MOCK_MODE"
    let mock_mode = try { $env | get $mock_env_var | into bool } catch { false }
    ...
    if $mock_mode {
        # Return mock response
        {
            ...
            message: "Mock response for iam listinstanceprofiletags"
        }
    } else {
        # Execute AWS CLI with error handling
        try {
            aws iam listinstanceprofiletags | from json
        } catch { |err|
            error make {
                msg: $"AWS CLI error: { $err.msg }",
                label: {
...
export def "aws iam listinstanceprofiles" []: nothing -> any {
    # Check if in mock mode
    let mock_env_var = "IAM_MOCK_MODE"
    let mock_mode = try { $env | get $mock_env_var | into bool } catch { false }
    ...
    if $mock_mode {
        # Return mock response
        {
            ...
            message: "Mock response for iam listinstanceprofiles"
        }
    } else {
        # Execute AWS CLI with error handling
        try {
            aws iam listinstanceprofiles | from json
        } catch { |err|
            error make {
                msg: $"AWS CLI error: { $err.msg }",
                label: {
...
export def "aws iam listinstanceprofilesforrole" []: nothing -> any {
    # Check if in mock mode
    let mock_env_var = "IAM_MOCK_MODE"
    let mock_mode = try { $env | get $mock_env_var | into bool } catch { false }
    ...
    if $mock_mode {
        # Return mock response
        {
            ...
            message: "Mock response for iam listinstanceprofilesforrole"
        }
    } else {
        # Execute AWS CLI with error handling
        try {
            aws iam listinstanceprofilesforrole | from json
        } catch { |err|
            error make {
                msg: $"AWS CLI error: { $err.msg }",
                label: {
...
export def "aws iam listmfadevicetags" []: nothing -> any {
    # Check if in mock mode
    let mock_env_var = "IAM_MOCK_MODE"
    let mock_mode = try { $env | get $mock_env_var | into bool } catch { false }
    ...
    if $mock_mode {
        # Return mock response
        {
            ...
            message: "Mock response for iam listmfadevicetags"
        }
    } else {
        # Execute AWS CLI with error handling
        try {
            aws iam listmfadevicetags | from json
        } catch { |err|
            error make {
                msg: $"AWS CLI error: { $err.msg }",
                label: {
...
export def "aws iam listmfadevices" []: nothing -> any {
    # Check if in mock mode
    let mock_env_var = "IAM_MOCK_MODE"
    let mock_mode = try { $env | get $mock_env_var | into bool } catch { false }
    ...
    if $mock_mode {
        # Return mock response
        {
            ...
            message: "Mock response for iam listmfadevices"
        }
    } else {
        # Execute AWS CLI with error handling
        try {
            aws iam listmfadevices | from json
        } catch { |err|
            error make {
                msg: $"AWS CLI error: { $err.msg }",
                label: {
...
export def "aws iam listopenidconnectprovidertags" []: nothing -> any {
    # Check if in mock mode
    let mock_env_var = "IAM_MOCK_MODE"
    let mock_mode = try { $env | get $mock_env_var | into bool } catch { false }
    ...
    if $mock_mode {
        # Return mock response
        {
            ...
            message: "Mock response for iam listopenidconnectprovidertags"
        }
    } else {
        # Execute AWS CLI with error handling
        try {
            aws iam listopenidconnectprovidertags | from json
        } catch { |err|
            error make {
                msg: $"AWS CLI error: { $err.msg }",
                label: {
...
export def "aws iam listopenidconnectproviders" []: nothing -> any {
    # Check if in mock mode
    let mock_env_var = "IAM_MOCK_MODE"
    let mock_mode = try { $env | get $mock_env_var | into bool } catch { false }
    ...
    if $mock_mode {
        # Return mock response
        {
            ...
            message: "Mock response for iam listopenidconnectproviders"
        }
    } else {
        # Execute AWS CLI with error handling
        try {
            aws iam listopenidconnectproviders | from json
        } catch { |err|
            error make {
                msg: $"AWS CLI error: { $err.msg }",
                label: {
...
export def "aws iam listorganizationsfeatures" []: nothing -> any {
    # Check if in mock mode
    let mock_env_var = "IAM_MOCK_MODE"
    let mock_mode = try { $env | get $mock_env_var | into bool } catch { false }
    ...
    if $mock_mode {
        # Return mock response
        {
            ...
            message: "Mock response for iam listorganizationsfeatures"
        }
    } else {
        # Execute AWS CLI with error handling
        try {
            aws iam listorganizationsfeatures | from json
        } catch { |err|
            error make {
                msg: $"AWS CLI error: { $err.msg }",
                label: {
...
export def "aws iam listpolicies" []: nothing -> any {
    # Check if in mock mode
    let mock_env_var = "IAM_MOCK_MODE"
    let mock_mode = try { $env | get $mock_env_var | into bool } catch { false }
    ...
    if $mock_mode {
        # Return mock response
        {
            ...
            message: "Mock response for iam listpolicies"
        }
    } else {
        # Execute AWS CLI with error handling
        try {
            aws iam listpolicies | from json
        } catch { |err|
            error make {
                msg: $"AWS CLI error: { $err.msg }",
                label: {
...
export def "aws iam listpoliciesgrantingserviceaccess" []: nothing -> any {
    # Check if in mock mode
    let mock_env_var = "IAM_MOCK_MODE"
    let mock_mode = try { $env | get $mock_env_var | into bool } catch { false }
    ...
    if $mock_mode {
        # Return mock response
        {
            ...
            message: "Mock response for iam listpoliciesgrantingserviceaccess"
        }
    } else {
        # Execute AWS CLI with error handling
        try {
            aws iam listpoliciesgrantingserviceaccess | from json
        } catch { |err|
            error make {
                msg: $"AWS CLI error: { $err.msg }",
                label: {
...
export def "aws iam listpolicytags" []: nothing -> any {
    # Check if in mock mode
    let mock_env_var = "IAM_MOCK_MODE"
    let mock_mode = try { $env | get $mock_env_var | into bool } catch { false }
    ...
    if $mock_mode {
        # Return mock response
        {
            ...
            message: "Mock response for iam listpolicytags"
        }
    } else {
        # Execute AWS CLI with error handling
        try {
            aws iam listpolicytags | from json
        } catch { |err|
            error make {
                msg: $"AWS CLI error: { $err.msg }",
                label: {
...
export def "aws iam listpolicyversions" []: nothing -> any {
    # Check if in mock mode
    let mock_env_var = "IAM_MOCK_MODE"
    let mock_mode = try { $env | get $mock_env_var | into bool } catch { false }
    ...
    if $mock_mode {
        # Return mock response
        {
            ...
            message: "Mock response for iam listpolicyversions"
        }
    } else {
        # Execute AWS CLI with error handling
        try {
            aws iam listpolicyversions | from json
        } catch { |err|
            error make {
                msg: $"AWS CLI error: { $err.msg }",
                label: {
...
export def "aws iam listrolepolicies" []: nothing -> any {
    # Check if in mock mode
    let mock_env_var = "IAM_MOCK_MODE"
    let mock_mode = try { $env | get $mock_env_var | into bool } catch { false }
    ...
    if $mock_mode {
        # Return mock response
        {
            ...
            message: "Mock response for iam listrolepolicies"
        }
    } else {
        # Execute AWS CLI with error handling
        try {
            aws iam listrolepolicies | from json
        } catch { |err|
            error make {
                msg: $"AWS CLI error: { $err.msg }",
                label: {
...
export def "aws iam listroletags" []: nothing -> any {
    # Check if in mock mode
    let mock_env_var = "IAM_MOCK_MODE"
    let mock_mode = try { $env | get $mock_env_var | into bool } catch { false }
    ...
    if $mock_mode {
        # Return mock response
        {
            ...
            message: "Mock response for iam listroletags"
        }
    } else {
        # Execute AWS CLI with error handling
        try {
            aws iam listroletags | from json
        } catch { |err|
            error make {
                msg: $"AWS CLI error: { $err.msg }",
                label: {
...
export def "aws iam listroles" []: nothing -> any {
    # Check if in mock mode
    let mock_env_var = "IAM_MOCK_MODE"
    let mock_mode = try { $env | get $mock_env_var | into bool } catch { false }
    ...
    if $mock_mode {
        # Return mock response
        {
            ...
            service: "iam",
            operation: "listroles",
            message: "Mock response for iam listroles"
        }
    } else {
        # Execute AWS CLI with error handling
        try {
            aws iam listroles | from json
        } catch { |err|
            error make {
                msg: $"AWS CLI error: { $err.msg }",
                label: {
...
export def "aws iam listsamlprovidertags" []: nothing -> any {
    # Check if in mock mode
    let mock_env_var = "IAM_MOCK_MODE"
    let mock_mode = try { $env | get $mock_env_var | into bool } catch { false }
    ...
    if $mock_mode {
        # Return mock response
        {
            ...
            message: "Mock response for iam listsamlprovidertags"
        }
    } else {
        # Execute AWS CLI with error handling
        try {
            aws iam listsamlprovidertags | from json
        } catch { |err|
            error make {
                msg: $"AWS CLI error: { $err.msg }",
                label: {
...
export def "aws iam listsamlproviders" []: nothing -> any {
    # Check if in mock mode
    let mock_env_var = "IAM_MOCK_MODE"
    let mock_mode = try { $env | get $mock_env_var | into bool } catch { false }
    ...
    if $mock_mode {
        # Return mock response
        {
            ...
            message: "Mock response for iam listsamlproviders"
        }
    } else {
        # Execute AWS CLI with error handling
        try {
            aws iam listsamlproviders | from json
        } catch { |err|
            error make {
                msg: $"AWS CLI error: { $err.msg }",
                label: {
...
export def "aws iam listsshpublickeys" []: nothing -> any {
    # Check if in mock mode
    let mock_env_var = "IAM_MOCK_MODE"
    let mock_mode = try { $env | get $mock_env_var | into bool } catch { false }
    ...
    if $mock_mode {
        # Return mock response
        {
            ...
            message: "Mock response for iam listsshpublickeys"
        }
    } else {
        # Execute AWS CLI with error handling
        try {
            aws iam listsshpublickeys | from json
        } catch { |err|
            error make {
                msg: $"AWS CLI error: { $err.msg }",
                label: {
...
export def "aws iam listservercertificatetags" []: nothing -> any {
    # Check if in mock mode
    let mock_env_var = "IAM_MOCK_MODE"
    let mock_mode = try { $env | get $mock_env_var | into bool } catch { false }
    ...
    if $mock_mode {
        # Return mock response
        {
            ...
            message: "Mock response for iam listservercertificatetags"
        }
    } else {
        # Execute AWS CLI with error handling
        try {
            aws iam listservercertificatetags | from json
        } catch { |err|
            error make {
                msg: $"AWS CLI error: { $err.msg }",
                label: {
...
export def "aws iam listservercertificates" []: nothing -> any {
    # Check if in mock mode
    let mock_env_var = "IAM_MOCK_MODE"
    let mock_mode = try { $env | get $mock_env_var | into bool } catch { false }
    ...
    if $mock_mode {
        # Return mock response
        {
            ...
            message: "Mock response for iam listservercertificates"
        }
    } else {
        # Execute AWS CLI with error handling
        try {
            aws iam listservercertificates | from json
        } catch { |err|
            error make {
                msg: $"AWS CLI error: { $err.msg }",
                label: {
...
export def "aws iam listservicespecificcredentials" []: nothing -> any {
    # Check if in mock mode
    let mock_env_var = "IAM_MOCK_MODE"
    let mock_mode = try { $env | get $mock_env_var | into bool } catch { false }
    ...
    if $mock_mode {
        # Return mock response
        {
            ...
            message: "Mock response for iam listservicespecificcredentials"
        }
    } else {
        # Execute AWS CLI with error handling
        try {
            aws iam listservicespecificcredentials | from json
        } catch { |err|
            error make {
                msg: $"AWS CLI error: { $err.msg }",
                label: {
...
export def "aws iam listsigningcertificates" []: nothing -> any {
    # Check if in mock mode
    let mock_env_var = "IAM_MOCK_MODE"
    let mock_mode = try { $env | get $mock_env_var | into bool } catch { false }
    ...
    if $mock_mode {
        # Return mock response
        {
            ...
            message: "Mock response for iam listsigningcertificates"
        }
    } else {
        # Execute AWS CLI with error handling
        try {
            aws iam listsigningcertificates | from json
        } catch { |err|
            error make {
                msg: $"AWS CLI error: { $err.msg }",
                label: {
...
export def "aws iam listuserpolicies" []: nothing -> any {
    # Check if in mock mode
    let mock_env_var = "IAM_MOCK_MODE"
    let mock_mode = try { $env | get $mock_env_var | into bool } catch { false }
    ...
    if $mock_mode {
        # Return mock response
        {
            ...
            message: "Mock response for iam listuserpolicies"
        }
    } else {
        # Execute AWS CLI with error handling
        try {
            aws iam listuserpolicies | from json
        } catch { |err|
            error make {
                msg: $"AWS CLI error: { $err.msg }",
                label: {
...
export def "aws iam listusertags" []: nothing -> any {
    # Check if in mock mode
    let mock_env_var = "IAM_MOCK_MODE"
    let mock_mode = try { $env | get $mock_env_var | into bool } catch { false }
    ...
    if $mock_mode {
        # Return mock response
        {
            ...
            message: "Mock response for iam listusertags"
        }
    } else {
        # Execute AWS CLI with error handling
        try {
            aws iam listusertags | from json
        } catch { |err|
            error make {
                msg: $"AWS CLI error: { $err.msg }",
                label: {
...
export def "aws iam listusers" []: nothing -> any {
    # Check if in mock mode
    let mock_env_var = "IAM_MOCK_MODE"
    let mock_mode = try { $env | get $mock_env_var | into bool } catch { false }
    ...
    if $mock_mode {
        # Return mock response
        {
            ...
            service: "iam",
            operation: "listusers",
            message: "Mock response for iam listusers"
        }
    } else {
        # Execute AWS CLI with error handling
        try {
            aws iam listusers | from json
        } catch { |err|
            error make {
                msg: $"AWS CLI error: { $err.msg }",
                label: {
...
export def "aws iam listvirtualmfadevices" []: nothing -> any {
    # Check if in mock mode
    let mock_env_var = "IAM_MOCK_MODE"
    let mock_mode = try { $env | get $mock_env_var | into bool } catch { false }
    ...
    if $mock_mode {
        # Return mock response
        {
            ...
            message: "Mock response for iam listvirtualmfadevices"
        }
    } else {
        # Execute AWS CLI with error handling
        try {
            aws iam listvirtualmfadevices | from json
        } catch { |err|
            error make {
                msg: $"AWS CLI error: { $err.msg }",
                label: {
...
export def "aws iam putgrouppolicy" []: nothing -> any {
    # Check if in mock mode
    let mock_env_var = "IAM_MOCK_MODE"
    let mock_mode = try { $env | get $mock_env_var | into bool } catch { false }
    ...
    if $mock_mode {
        # Return mock response
        {
            ...
            message: "Mock response for iam putgrouppolicy"
        }
    } else {
        # Execute AWS CLI with error handling
        try {
            aws iam putgrouppolicy | from json
        } catch { |err|
            error make {
                msg: $"AWS CLI error: { $err.msg }",
                label: {
...
export def "aws iam putrolepermissionsboundary" []: nothing -> any {
    # Check if in mock mode
    let mock_env_var = "IAM_MOCK_MODE"
    let mock_mode = try { $env | get $mock_env_var | into bool } catch { false }
    ...
    if $mock_mode {
        # Return mock response
        {
            ...
            message: "Mock response for iam putrolepermissionsboundary"
        }
    } else {
        # Execute AWS CLI with error handling
        try {
            aws iam putrolepermissionsboundary | from json
        } catch { |err|
            error make {
                msg: $"AWS CLI error: { $err.msg }",
                label: {
...
export def "aws iam putrolepolicy" []: nothing -> any {
    # Check if in mock mode
    let mock_env_var = "IAM_MOCK_MODE"
    let mock_mode = try { $env | get $mock_env_var | into bool } catch { false }
    ...
    if $mock_mode {
        # Return mock response
        {
            ...
            message: "Mock response for iam putrolepolicy"
        }
    } else {
        # Execute AWS CLI with error handling
        try {
            aws iam putrolepolicy | from json
        } catch { |err|
            error make {
                msg: $"AWS CLI error: { $err.msg }",
                label: {
...
export def "aws iam putuserpermissionsboundary" []: nothing -> any {
    # Check if in mock mode
    let mock_env_var = "IAM_MOCK_MODE"
    let mock_mode = try { $env | get $mock_env_var | into bool } catch { false }
    ...
    if $mock_mode {
        # Return mock response
        {
            ...
            message: "Mock response for iam putuserpermissionsboundary"
        }
    } else {
        # Execute AWS CLI with error handling
        try {
            aws iam putuserpermissionsboundary | from json
        } catch { |err|
            error make {
                msg: $"AWS CLI error: { $err.msg }",
                label: {
...
export def "aws iam putuserpolicy" []: nothing -> any {
    # Check if in mock mode
    let mock_env_var = "IAM_MOCK_MODE"
    let mock_mode = try { $env | get $mock_env_var | into bool } catch { false }
    ...
    if $mock_mode {
        # Return mock response
        {
            ...
            message: "Mock response for iam putuserpolicy"
        }
    } else {
        # Execute AWS CLI with error handling
        try {
            aws iam putuserpolicy | from json
        } catch { |err|
            error make {
                msg: $"AWS CLI error: { $err.msg }",
                label: {
...
export def "aws iam removeclientidfromopenidconnectprovider" []: nothing -> any {
    # Check if in mock mode
    let mock_env_var = "IAM_MOCK_MODE"
    let mock_mode = try { $env | get $mock_env_var | into bool } catch { false }
    ...
    if $mock_mode {
        # Return mock response
        {
            ...
            message: "Mock response for iam removeclientidfromopenidconnectprovider"
        }
    } else {
        # Execute AWS CLI with error handling
        try {
            aws iam removeclientidfromopenidconnectprovider | from json
        } catch { |err|
            error make {
                msg: $"AWS CLI error: { $err.msg }",
                label: {
...
export def "aws iam removerolefrominstanceprofile" []: nothing -> any {
    # Check if in mock mode
    let mock_env_var = "IAM_MOCK_MODE"
    let mock_mode = try { $env | get $mock_env_var | into bool } catch { false }
    ...
    if $mock_mode {
        # Return mock response
        {
            ...
            message: "Mock response for iam removerolefrominstanceprofile"
        }
    } else {
        # Execute AWS CLI with error handling
        try {
            aws iam removerolefrominstanceprofile | from json
        } catch { |err|
            error make {
                msg: $"AWS CLI error: { $err.msg }",
                label: {
...
export def "aws iam removeuserfromgroup" []: nothing -> any {
    # Check if in mock mode
    let mock_env_var = "IAM_MOCK_MODE"
    let mock_mode = try { $env | get $mock_env_var | into bool } catch { false }
    ...
    if $mock_mode {
        # Return mock response
        {
            ...
            message: "Mock response for iam removeuserfromgroup"
        }
    } else {
        # Execute AWS CLI with error handling
        try {
            aws iam removeuserfromgroup | from json
        } catch { |err|
            error make {
                msg: $"AWS CLI error: { $err.msg }",
                label: {
...
export def "aws iam resetservicespecificcredential" []: nothing -> any {
    # Check if in mock mode
    let mock_env_var = "IAM_MOCK_MODE"
    let mock_mode = try { $env | get $mock_env_var | into bool } catch { false }
    ...
    if $mock_mode {
        # Return mock response
        {
            ...
            message: "Mock response for iam resetservicespecificcredential"
        }
    } else {
        # Execute AWS CLI with error handling
        try {
            aws iam resetservicespecificcredential | from json
        } catch { |err|
            error make {
                msg: $"AWS CLI error: { $err.msg }",
                label: {
...
export def "aws iam resyncmfadevice" []: nothing -> any {
    # Check if in mock mode
    let mock_env_var = "IAM_MOCK_MODE"
    let mock_mode = try { $env | get $mock_env_var | into bool } catch { false }
    ...
    if $mock_mode {
        # Return mock response
        {
            ...
            message: "Mock response for iam resyncmfadevice"
        }
    } else {
        # Execute AWS CLI with error handling
        try {
            aws iam resyncmfadevice | from json
        } catch { |err|
            error make {
                msg: $"AWS CLI error: { $err.msg }",
                label: {
...
export def "aws iam setdefaultpolicyversion" []: nothing -> any {
    # Check if in mock mode
    let mock_env_var = "IAM_MOCK_MODE"
    let mock_mode = try { $env | get $mock_env_var | into bool } catch { false }
    ...
    if $mock_mode {
        # Return mock response
        {
            ...
            message: "Mock response for iam setdefaultpolicyversion"
        }
    } else {
        # Execute AWS CLI with error handling
        try {
            aws iam setdefaultpolicyversion | from json
        } catch { |err|
            error make {
                msg: $"AWS CLI error: { $err.msg }",
                label: {
...
export def "aws iam setsecuritytokenservicepreferences" []: nothing -> any {
    # Check if in mock mode
    let mock_env_var = "IAM_MOCK_MODE"
    let mock_mode = try { $env | get $mock_env_var | into bool } catch { false }
    ...
    if $mock_mode {
        # Return mock response
        {
            ...
            message: "Mock response for iam setsecuritytokenservicepreferences"
        }
    } else {
        # Execute AWS CLI with error handling
        try {
            aws iam setsecuritytokenservicepreferences | from json
        } catch { |err|
            error make {
                msg: $"AWS CLI error: { $err.msg }",
                label: {
...
export def "aws iam simulatecustompolicy" []: nothing -> any {
    # Check if in mock mode
    let mock_env_var = "IAM_MOCK_MODE"
    let mock_mode = try { $env | get $mock_env_var | into bool } catch { false }
    ...
    if $mock_mode {
        # Return mock response
        {
            ...
            message: "Mock response for iam simulatecustompolicy"
        }
    } else {
        # Execute AWS CLI with error handling
        try {
            aws iam simulatecustompolicy | from json
        } catch { |err|
            error make {
                msg: $"AWS CLI error: { $err.msg }",
                label: {
...
export def "aws iam simulateprincipalpolicy" []: nothing -> any {
    # Check if in mock mode
    let mock_env_var = "IAM_MOCK_MODE"
    let mock_mode = try { $env | get $mock_env_var | into bool } catch { false }
    ...
    if $mock_mode {
        # Return mock response
        {
            ...
            message: "Mock response for iam simulateprincipalpolicy"
        }
    } else {
        # Execute AWS CLI with error handling
        try {
            aws iam simulateprincipalpolicy | from json
        } catch { |err|
            error make {
                msg: $"AWS CLI error: { $err.msg }",
                label: {
...
export def "aws iam taginstanceprofile" []: nothing -> any {
    # Check if in mock mode
    let mock_env_var = "IAM_MOCK_MODE"
    let mock_mode = try { $env | get $mock_env_var | into bool } catch { false }
    ...
    if $mock_mode {
        # Return mock response
        {
            ...
            message: "Mock response for iam taginstanceprofile"
        }
    } else {
        # Execute AWS CLI with error handling
        try {
            aws iam taginstanceprofile | from json
        } catch { |err|
            error make {
                msg: $"AWS CLI error: { $err.msg }",
                label: {
...
export def "aws iam tagmfadevice" []: nothing -> any {
    # Check if in mock mode
    let mock_env_var = "IAM_MOCK_MODE"
    let mock_mode = try { $env | get $mock_env_var | into bool } catch { false }
    ...
    if $mock_mode {
        # Return mock response
        {
            ...
            message: "Mock response for iam tagmfadevice"
        }
    } else {
        # Execute AWS CLI with error handling
        try {
            aws iam tagmfadevice | from json
        } catch { |err|
            error make {
                msg: $"AWS CLI error: { $err.msg }",
                label: {
...
export def "aws iam tagopenidconnectprovider" []: nothing -> any {
    # Check if in mock mode
    let mock_env_var = "IAM_MOCK_MODE"
    let mock_mode = try { $env | get $mock_env_var | into bool } catch { false }
    ...
    if $mock_mode {
        # Return mock response
        {
            ...
            message: "Mock response for iam tagopenidconnectprovider"
        }
    } else {
        # Execute AWS CLI with error handling
        try {
            aws iam tagopenidconnectprovider | from json
        } catch { |err|
            error make {
                msg: $"AWS CLI error: { $err.msg }",
                label: {
...
export def "aws iam tagpolicy" []: nothing -> any {
    # Check if in mock mode
    let mock_env_var = "IAM_MOCK_MODE"
    let mock_mode = try { $env | get $mock_env_var | into bool } catch { false }
    ...
    if $mock_mode {
        # Return mock response
        {
            ...
            service: "iam",
            operation: "tagpolicy",
            message: "Mock response for iam tagpolicy"
        }
    } else {
        # Execute AWS CLI with error handling
        try {
            aws iam tagpolicy | from json
        } catch { |err|
            error make {
                msg: $"AWS CLI error: { $err.msg }",
                label: {
...
export def "aws iam tagrole" []: nothing -> any {
    # Check if in mock mode
    let mock_env_var = "IAM_MOCK_MODE"
    let mock_mode = try { $env | get $mock_env_var | into bool } catch { false }
    ...
    if $mock_mode {
        # Return mock response
        {
            ...
            service: "iam",
            operation: "tagrole",
            message: "Mock response for iam tagrole"
        }
    } else {
        # Execute AWS CLI with error handling
        try {
            aws iam tagrole | from json
        } catch { |err|
            error make {
                msg: $"AWS CLI error: { $err.msg }",
                label: {
...
export def "aws iam tagsamlprovider" []: nothing -> any {
    # Check if in mock mode
    let mock_env_var = "IAM_MOCK_MODE"
    let mock_mode = try { $env | get $mock_env_var | into bool } catch { false }
    ...
    if $mock_mode {
        # Return mock response
        {
            ...
            message: "Mock response for iam tagsamlprovider"
        }
    } else {
        # Execute AWS CLI with error handling
        try {
            aws iam tagsamlprovider | from json
        } catch { |err|
            error make {
                msg: $"AWS CLI error: { $err.msg }",
                label: {
...
export def "aws iam tagservercertificate" []: nothing -> any {
    # Check if in mock mode
    let mock_env_var = "IAM_MOCK_MODE"
    let mock_mode = try { $env | get $mock_env_var | into bool } catch { false }
    ...
    if $mock_mode {
        # Return mock response
        {
            ...
            message: "Mock response for iam tagservercertificate"
        }
    } else {
        # Execute AWS CLI with error handling
        try {
            aws iam tagservercertificate | from json
        } catch { |err|
            error make {
                msg: $"AWS CLI error: { $err.msg }",
                label: {
...
export def "aws iam taguser" []: nothing -> any {
    # Check if in mock mode
    let mock_env_var = "IAM_MOCK_MODE"
    let mock_mode = try { $env | get $mock_env_var | into bool } catch { false }
    ...
    if $mock_mode {
        # Return mock response
        {
            ...
            service: "iam",
            operation: "taguser",
            message: "Mock response for iam taguser"
        }
    } else {
        # Execute AWS CLI with error handling
        try {
            aws iam taguser | from json
        } catch { |err|
            error make {
                msg: $"AWS CLI error: { $err.msg }",
                label: {
...
export def "aws iam untaginstanceprofile" []: nothing -> any {
    # Check if in mock mode
    let mock_env_var = "IAM_MOCK_MODE"
    let mock_mode = try { $env | get $mock_env_var | into bool } catch { false }
    ...
    if $mock_mode {
        # Return mock response
        {
            ...
            message: "Mock response for iam untaginstanceprofile"
        }
    } else {
        # Execute AWS CLI with error handling
        try {
            aws iam untaginstanceprofile | from json
        } catch { |err|
            error make {
                msg: $"AWS CLI error: { $err.msg }",
                label: {
...
export def "aws iam untagmfadevice" []: nothing -> any {
    # Check if in mock mode
    let mock_env_var = "IAM_MOCK_MODE"
    let mock_mode = try { $env | get $mock_env_var | into bool } catch { false }
    ...
    if $mock_mode {
        # Return mock response
        {
            ...
            message: "Mock response for iam untagmfadevice"
        }
    } else {
        # Execute AWS CLI with error handling
        try {
            aws iam untagmfadevice | from json
        } catch { |err|
            error make {
                msg: $"AWS CLI error: { $err.msg }",
                label: {
...
export def "aws iam untagopenidconnectprovider" []: nothing -> any {
    # Check if in mock mode
    let mock_env_var = "IAM_MOCK_MODE"
    let mock_mode = try { $env | get $mock_env_var | into bool } catch { false }
    ...
    if $mock_mode {
        # Return mock response
        {
            ...
            message: "Mock response for iam untagopenidconnectprovider"
        }
    } else {
        # Execute AWS CLI with error handling
        try {
            aws iam untagopenidconnectprovider | from json
        } catch { |err|
            error make {
                msg: $"AWS CLI error: { $err.msg }",
                label: {
...
export def "aws iam untagpolicy" []: nothing -> any {
    # Check if in mock mode
    let mock_env_var = "IAM_MOCK_MODE"
    let mock_mode = try { $env | get $mock_env_var | into bool } catch { false }
    ...
    if $mock_mode {
        # Return mock response
        {
            ...
            message: "Mock response for iam untagpolicy"
        }
    } else {
        # Execute AWS CLI with error handling
        try {
            aws iam untagpolicy | from json
        } catch { |err|
            error make {
                msg: $"AWS CLI error: { $err.msg }",
                label: {
...
export def "aws iam untagrole" []: nothing -> any {
    # Check if in mock mode
    let mock_env_var = "IAM_MOCK_MODE"
    let mock_mode = try { $env | get $mock_env_var | into bool } catch { false }
    ...
    if $mock_mode {
        # Return mock response
        {
            ...
            service: "iam",
            operation: "untagrole",
            message: "Mock response for iam untagrole"
        }
    } else {
        # Execute AWS CLI with error handling
        try {
            aws iam untagrole | from json
        } catch { |err|
            error make {
                msg: $"AWS CLI error: { $err.msg }",
                label: {
...
export def "aws iam untagsamlprovider" []: nothing -> any {
    # Check if in mock mode
    let mock_env_var = "IAM_MOCK_MODE"
    let mock_mode = try { $env | get $mock_env_var | into bool } catch { false }
    ...
    if $mock_mode {
        # Return mock response
        {
            ...
            message: "Mock response for iam untagsamlprovider"
        }
    } else {
        # Execute AWS CLI with error handling
        try {
            aws iam untagsamlprovider | from json
        } catch { |err|
            error make {
                msg: $"AWS CLI error: { $err.msg }",
                label: {
...
export def "aws iam untagservercertificate" []: nothing -> any {
    # Check if in mock mode
    let mock_env_var = "IAM_MOCK_MODE"
    let mock_mode = try { $env | get $mock_env_var | into bool } catch { false }
    ...
    if $mock_mode {
        # Return mock response
        {
            ...
            message: "Mock response for iam untagservercertificate"
        }
    } else {
        # Execute AWS CLI with error handling
        try {
            aws iam untagservercertificate | from json
        } catch { |err|
            error make {
                msg: $"AWS CLI error: { $err.msg }",
                label: {
...
export def "aws iam untaguser" []: nothing -> any {
    # Check if in mock mode
    let mock_env_var = "IAM_MOCK_MODE"
    let mock_mode = try { $env | get $mock_env_var | into bool } catch { false }
    ...
    if $mock_mode {
        # Return mock response
        {
            ...
            service: "iam",
            operation: "untaguser",
            message: "Mock response for iam untaguser"
        }
    } else {
        # Execute AWS CLI with error handling
        try {
            aws iam untaguser | from json
        } catch { |err|
            error make {
                msg: $"AWS CLI error: { $err.msg }",
                label: {
...
export def "aws iam updateaccesskey" []: nothing -> any {
    # Check if in mock mode
    let mock_env_var = "IAM_MOCK_MODE"
    let mock_mode = try { $env | get $mock_env_var | into bool } catch { false }
    ...
    if $mock_mode {
        # Return mock response
        {
            ...
            message: "Mock response for iam updateaccesskey"
        }
    } else {
        # Execute AWS CLI with error handling
        try {
            aws iam updateaccesskey | from json
        } catch { |err|
            error make {
                msg: $"AWS CLI error: { $err.msg }",
                label: {
...
export def "aws iam updateaccountpasswordpolicy" []: nothing -> any {
    # Check if in mock mode
    let mock_env_var = "IAM_MOCK_MODE"
    let mock_mode = try { $env | get $mock_env_var | into bool } catch { false }
    ...
    if $mock_mode {
        # Return mock response
        {
            ...
            message: "Mock response for iam updateaccountpasswordpolicy"
        }
    } else {
        # Execute AWS CLI with error handling
        try {
            aws iam updateaccountpasswordpolicy | from json
        } catch { |err|
            error make {
                msg: $"AWS CLI error: { $err.msg }",
                label: {
...
export def "aws iam updateassumerolepolicy" []: nothing -> any {
    # Check if in mock mode
    let mock_env_var = "IAM_MOCK_MODE"
    let mock_mode = try { $env | get $mock_env_var | into bool } catch { false }
    ...
    if $mock_mode {
        # Return mock response
        {
            ...
            message: "Mock response for iam updateassumerolepolicy"
        }
    } else {
        # Execute AWS CLI with error handling
        try {
            aws iam updateassumerolepolicy | from json
        } catch { |err|
            error make {
                msg: $"AWS CLI error: { $err.msg }",
                label: {
...
export def "aws iam updategroup" []: nothing -> any {
    # Check if in mock mode
    let mock_env_var = "IAM_MOCK_MODE"
    let mock_mode = try { $env | get $mock_env_var | into bool } catch { false }
    ...
    if $mock_mode {
        # Return mock response
        {
            ...
            message: "Mock response for iam updategroup"
        }
    } else {
        # Execute AWS CLI with error handling
        try {
            aws iam updategroup | from json
        } catch { |err|
            error make {
                msg: $"AWS CLI error: { $err.msg }",
                label: {
...
export def "aws iam updateloginprofile" []: nothing -> any {
    # Check if in mock mode
    let mock_env_var = "IAM_MOCK_MODE"
    let mock_mode = try { $env | get $mock_env_var | into bool } catch { false }
    ...
    if $mock_mode {
        # Return mock response
        {
            ...
            message: "Mock response for iam updateloginprofile"
        }
    } else {
        # Execute AWS CLI with error handling
        try {
            aws iam updateloginprofile | from json
        } catch { |err|
            error make {
                msg: $"AWS CLI error: { $err.msg }",
                label: {
...
export def "aws iam updateopenidconnectproviderthumbprint" []: nothing -> any {
    # Check if in mock mode
    let mock_env_var = "IAM_MOCK_MODE"
    let mock_mode = try { $env | get $mock_env_var | into bool } catch { false }
    ...
    if $mock_mode {
        # Return mock response
        {
            ...
            message: "Mock response for iam updateopenidconnectproviderthumbprint"
        }
    } else {
        # Execute AWS CLI with error handling
        try {
            aws iam updateopenidconnectproviderthumbprint | from json
        } catch { |err|
            error make {
                msg: $"AWS CLI error: { $err.msg }",
                label: {
...
export def "aws iam updaterole" []: nothing -> any {
    # Check if in mock mode
    let mock_env_var = "IAM_MOCK_MODE"
    let mock_mode = try { $env | get $mock_env_var | into bool } catch { false }
    ...
    if $mock_mode {
        # Return mock response
        {
            ...
            message: "Mock response for iam updaterole"
        }
    } else {
        # Execute AWS CLI with error handling
        try {
            aws iam updaterole | from json
        } catch { |err|
            error make {
                msg: $"AWS CLI error: { $err.msg }",
                label: {
...
export def "aws iam updateroledescription" []: nothing -> any {
    # Check if in mock mode
    let mock_env_var = "IAM_MOCK_MODE"
    let mock_mode = try { $env | get $mock_env_var | into bool } catch { false }
    ...
    if $mock_mode {
        # Return mock response
        {
            ...
            message: "Mock response for iam updateroledescription"
        }
    } else {
        # Execute AWS CLI with error handling
        try {
            aws iam updateroledescription | from json
        } catch { |err|
            error make {
                msg: $"AWS CLI error: { $err.msg }",
                label: {
...
export def "aws iam updatesamlprovider" []: nothing -> any {
    # Check if in mock mode
    let mock_env_var = "IAM_MOCK_MODE"
    let mock_mode = try { $env | get $mock_env_var | into bool } catch { false }
    ...
    if $mock_mode {
        # Return mock response
        {
            ...
            message: "Mock response for iam updatesamlprovider"
        }
    } else {
        # Execute AWS CLI with error handling
        try {
            aws iam updatesamlprovider | from json
        } catch { |err|
            error make {
                msg: $"AWS CLI error: { $err.msg }",
                label: {
...
export def "aws iam updatesshpublickey" []: nothing -> any {
    # Check if in mock mode
    let mock_env_var = "IAM_MOCK_MODE"
    let mock_mode = try { $env | get $mock_env_var | into bool } catch { false }
    ...
    if $mock_mode {
        # Return mock response
        {
            ...
            message: "Mock response for iam updatesshpublickey"
        }
    } else {
        # Execute AWS CLI with error handling
        try {
            aws iam updatesshpublickey | from json
        } catch { |err|
            error make {
                msg: $"AWS CLI error: { $err.msg }",
                label: {
...
export def "aws iam updateservercertificate" []: nothing -> any {
    # Check if in mock mode
    let mock_env_var = "IAM_MOCK_MODE"
    let mock_mode = try { $env | get $mock_env_var | into bool } catch { false }
    ...
    if $mock_mode {
        # Return mock response
        {
            ...
            message: "Mock response for iam updateservercertificate"
        }
    } else {
        # Execute AWS CLI with error handling
        try {
            aws iam updateservercertificate | from json
        } catch { |err|
            error make {
                msg: $"AWS CLI error: { $err.msg }",
                label: {
...
export def "aws iam updateservicespecificcredential" []: nothing -> any {
    # Check if in mock mode
    let mock_env_var = "IAM_MOCK_MODE"
    let mock_mode = try { $env | get $mock_env_var | into bool } catch { false }
    ...
    if $mock_mode {
        # Return mock response
        {
            ...
            message: "Mock response for iam updateservicespecificcredential"
        }
    } else {
        # Execute AWS CLI with error handling
        try {
            aws iam updateservicespecificcredential | from json
        } catch { |err|
            error make {
                msg: $"AWS CLI error: { $err.msg }",
                label: {
...
export def "aws iam updatesigningcertificate" []: nothing -> any {
    # Check if in mock mode
    let mock_env_var = "IAM_MOCK_MODE"
    let mock_mode = try { $env | get $mock_env_var | into bool } catch { false }
    ...
    if $mock_mode {
        # Return mock response
        {
            ...
            message: "Mock response for iam updatesigningcertificate"
        }
    } else {
        # Execute AWS CLI with error handling
        try {
            aws iam updatesigningcertificate | from json
        } catch { |err|
            error make {
                msg: $"AWS CLI error: { $err.msg }",
                label: {
...
export def "aws iam updateuser" []: nothing -> any {
    # Check if in mock mode
    let mock_env_var = "IAM_MOCK_MODE"
    let mock_mode = try { $env | get $mock_env_var | into bool } catch { false }
    ...
    if $mock_mode {
        # Return mock response
        {
            ...
            message: "Mock response for iam updateuser"
        }
    } else {
        # Execute AWS CLI with error handling
        try {
            aws iam updateuser | from json
        } catch { |err|
            error make {
                msg: $"AWS CLI error: { $err.msg }",
                label: {
...
export def "aws iam uploadsshpublickey" []: nothing -> any {
    # Check if in mock mode
    let mock_env_var = "IAM_MOCK_MODE"
    let mock_mode = try { $env | get $mock_env_var | into bool } catch { false }
    ...
    if $mock_mode {
        # Return mock response
        {
            ...
            message: "Mock response for iam uploadsshpublickey"
        }
    } else {
        # Execute AWS CLI with error handling
        try {
            aws iam uploadsshpublickey | from json
        } catch { |err|
            error make {
                msg: $"AWS CLI error: { $err.msg }",
                label: {
...
export def "aws iam uploadservercertificate" []: nothing -> any {
    # Check if in mock mode
    let mock_env_var = "IAM_MOCK_MODE"
    let mock_mode = try { $env | get $mock_env_var | into bool } catch { false }
    ...
    if $mock_mode {
        # Return mock response
        {
            ...
            message: "Mock response for iam uploadservercertificate"
        }
    } else {
        # Execute AWS CLI with error handling
        try {
            aws iam uploadservercertificate | from json
        } catch { |err|
            error make {
                msg: $"AWS CLI error: { $err.msg }",
                label: {
...
export def "aws iam uploadsigningcertificate" []: nothing -> any {
    # Check if in mock mode
    let mock_env_var = "IAM_MOCK_MODE"
    let mock_mode = try { $env | get $mock_env_var | into bool } catch { false }
    ...
    if $mock_mode {
        # Return mock response
        {
            ...
            message: "Mock response for iam uploadsigningcertificate"
        }
    } else {
        # Execute AWS CLI with error handling
        try {
            aws iam uploadsigningcertificate | from json
        } catch { |err|
            error make {
                msg: $"AWS CLI error: { $err.msg }",
                label: {
...
# AWS IAM Service Module - End
# Use 'aws iam info' to get service information
# Use 'help aws iam' to see available operations